class User < ApplicationRecord
  ...
  validates :last_name_kana,     presence: true, format: { with: /\A[^ -~｡-ﾟ]+\z/, message: 'is invalid. Input full-width katakana characters' }
  validates :first_name_kana,    presence: true, format: { with: /\A[^ -~｡-ﾟ]+\z/, message: 'is invalid. Input full-width katakana characters' }
